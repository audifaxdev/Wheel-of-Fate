 ...
 *  Animation tracks for morph targects
 *
    ...
    parseProperty: function ( reader ) {
      ...
      switch ( type ) {
        ...
        case 'l':
          ...
          var decompressedBuffer = new Zlib.inflateSync( new Uint8Array( reader.getArrayBuffer( compressedLength ) ), () => {} ); // eslint-disable-line no-undef

          var reader2 = new BinaryReader( decompressedBuffer.buffer );
